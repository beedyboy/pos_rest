...
//	 $.each(localOrder, function(index, value){
		//alert(index +": "+ value + " Quantity: "+ localQuantity[index]);
	//	 });
    ...
    /**
     ...
     /**
	  ...
	  setInterval(function(){ 
	   ...
	   fetch_receivable_data();}, 30000);
  
	     
 //$('.dmenu').change(function(){
