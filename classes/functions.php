...
$stmt = $conn->db->prepare("INSERT INTO sales (invoice_number, cashier, date, amount, discount, tid, sid, hall, balance, ord_type) 
 VALUES (:invoice_number, :cashier, :date, :amount, :discount, :tid, :sid,:hall, :balance, :ord_type)"); 
...
foreach ($qry as $value) {
	...
	$result =$conn->db->prepare("DELETE FROM sales_order WHERE invoice= :invoice");
